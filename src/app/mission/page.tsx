...
export default function MissionPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#0A0A0A', position: 'relative' }}>
      <img src="/mission.JPG" alt="" style={{ position: 'fixed', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'center 30%', opacity: 0.30, transform: 'scale(0.9)', zIndex: 0 }} />
