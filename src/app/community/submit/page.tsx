...
export default function SubmitPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#0A0A0A', position: 'relative' }}>
      <video src="/waterfall_bali_web.mp4" muted loop playsInline autoPlay style={{ position: 'fixed', inset: 0, width: '100%', height: '100%', objectFit: 'cover', opacity: 0.15, zIndex: 0 }} />
