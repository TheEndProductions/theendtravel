    ...
    <>
      <div>
        ...
        <section style={{ position: 'relative', padding: '200px 24px', overflow: 'hidden' }}>
          <video src="/waterfall_bali_web.mp4" muted loop playsInline autoPlay style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', opacity: 0.36, zIndex: 0 }} />
        ...
        <section id="endless" style={{ position: 'relative', padding: '100px 24px', overflow: 'hidden' }}>
          <img src="/endless-section-bg.jpg" alt="" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', opacity: 0.36 }} />
