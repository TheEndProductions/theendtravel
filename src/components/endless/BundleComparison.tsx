  ...
  return (
    <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap', alignItems: 'stretch' }}>
      ...
      <div style={{ flex: '1 1 260px', padding: '28px', borderRadius: '12px', border: '1px solid #C4530A', background: 'rgba(196,83,10,0.06)', display: 'flex', flexDirection: 'column', gap: '16px', position: 'relative' }}>
        ...
        <div style={{ fontFamily: '"JetBrains Mono", monospace', fontSize: '10px', color: '#C4530A', textTransform: 'uppercase', letterSpacing: '0.1em' }}>The Endless Ecosystem</div>
        <div style={{ fontFamily: '"DM Sans", sans-serif', fontSize: '14px', color: '#D4CFC7', lineHeight: 1.5 }}>All 4 pieces. One ecosystem. Built to work together.</div>
